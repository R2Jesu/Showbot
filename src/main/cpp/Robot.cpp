...
m_encL.Reset();
m_encR.Reset();
m_encL.SetDistancePerPulse(1.0 / 2048.0 * 2.0 * M_PI * 3.0);
m_encR.SetDistancePerPulse(1.0 / 2048.0 * 2.0 * M_PI * 3.0);
  // Vision & Camera Init

  // Drive USB Camera - 1
  cs::UsbCamera drvCamera = frc::CameraServer::StartAutomaticCapture(0);
