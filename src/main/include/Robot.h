...
// Ball Shooter Subsystem - Pneumatics & Motor
  ...
  rev::SparkMaxRelativeEncoder m_ShooterEncoderLeft = m_ShooterMotorLeft.GetEncoder();
  rev::SparkMaxRelativeEncoder m_ShooterEncoderRight = m_ShooterMotorRight.GetEncoder();
  ...
  frc::Solenoid ballPopper{frc::PneumaticsModuleType::CTREPCM, 0};
  frc::Solenoid colorArm{frc::PneumaticsModuleType::CTREPCM, 1};
  frc::DoubleSolenoid jaws{frc::PneumaticsModuleType::CTREPCM, 2, 3};
#endif
